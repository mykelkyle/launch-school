...
#explanation: the return value of a proc calls #to_s and is an object
# the class of a proc is a proc
# invoking a proc outputs the block
...
#explanation: lambdas are a type of proc that have a stricter arity
...
#explanation: need to pass in parameter object as an argument to the yield invocation for the block to return the proper value. Also, blocks have stricer arity, they cannot yield to a non-existent block.
